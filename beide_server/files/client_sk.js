$(document).ready(function(){
	...
	function init(username) {
		...
		function begin() {
			...
			ctx.fillText("Čaká sa na hráčov...", 800, 350);
			ctx.textAlign = "start";
		...
		function reset(sco,winner) {
			...
			if(!isNaN(sco)) {
				ctx.font = "50px Arial";
				ctx.textAlign = "center";
				ctx.fillText("Skóre: "+sco, 800, 120);
				ctx.textAlign = "start";
			}
			if(winner) {
				ctx.font = "75px Arial";
				ctx.textAlign = "center";
				ctx.fillText(winner+" vyhral!", 800, 500);
				ctx.textAlign = "start";
			}
			ctx.font = "100px Arial";
			ctx.textAlign = "center";
			ctx.fillText("Koniec hry", 800, 350);
			ctx.textAlign = "start";
		...
		socket.on('full',function(){
			setTimeout(function() {
				...
				ctx.font = "100px Arial";
				ctx.textAlign = "center";
				ctx.fillText("Server je plný :(", 800, 350);
				ctx.textAlign = "start";
				$("body").css('background-color','#ffcc99');
			},500);
		...
		socket.on('close',function(){
			...
			ctx.font = "100px Arial";
			ctx.textAlign = "center";
			ctx.fillText("Server sa vypol :(", 800, 350);
			ctx.textAlign = "start";
		});
		socket.on('idle',function(){
			...
			ctx.font = "100px Arial";
			ctx.textAlign = "center";
			ctx.fillText("Čakanie na admina...", 800, 350);
			ctx.textAlign = "start";
		});
		...
		socket.on('notify',function(){
			...
			ctx.font = "100px Arial";
			ctx.textAlign = "center";
			ctx.fillText("Pripravte sa", 800, 350);
			ctx.textAlign = "start";
			$("body").css('background-color','#ccffcc');
		});
